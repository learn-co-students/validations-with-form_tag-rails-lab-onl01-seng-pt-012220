class Author < ActiveRecord::Base
    ...
    validates :email, uniqueness: {:message => "has an account already"}, exclusion: {within: %w("bro@sbahj.info")}
    validates :phone_number, length: {:is => 10}, exclusion: {within: %w("555035995")}
