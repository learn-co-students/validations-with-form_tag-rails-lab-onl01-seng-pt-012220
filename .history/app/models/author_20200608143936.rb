class Author < ActiveRecord::Base
    ...
    validates :email, uniqueness: {:message => "has an account already"}, exclusion: {within: "bro@sbahj.info"}
    validates :phone_number, length: {:is => 10}, exclusion: {within: "555035995"}
